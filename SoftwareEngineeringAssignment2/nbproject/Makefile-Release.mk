...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/softwareengineeringassignment2.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/softwareengineeringassignment2.exe: ${OBJECTFILES}
...
${OBJECTDIR}/gameInitialisation.o: gameInitialisation.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gameInitialisation.o gameInitialisation.c
...
${OBJECTDIR}/stackFunctions.o: stackFunctions.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stackFunctions.o stackFunctions.c
